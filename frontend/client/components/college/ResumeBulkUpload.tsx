...
const ResumeBulkUpload: React.FC = () => {
    ...
    const fetchTotalResumes = useCallback(async () => {
        try {
            const response = await fetch('http://localhost:8000/api/v1/college-portal/resumes');
    ...
    const handleUpload = async () => {
        ...
        try {
            ...
            const response = await fetch('http://localhost:8000/api/v1/college-portal/resumes/upload', {
                method: 'POST',
                body: formData
            });
